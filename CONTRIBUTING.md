# Contributing to magic Dart Auth SDK

Thank you for considering contributing to the magic Dart Authentication SDK, a Dart implementation for magic Authentication services designed to work out of the box for any application that wants to use magic and dart together.
...
By participating and contributing to magic Dart Admin Auth SDK, you are expected to uphold our [Code of Conduct](CODE_OF_CONDUCT.md).
...
magic Dart Admin Auth SDK is available in two versions to cater to different needs and scales:
...
- Inspired by the simplicity of [magic_Dart](#).
- Thanks to the Dart community for continuous support and inspiration.

We would like to extend our gratitude to all the developers and contributors who have made this magic Dart SDK possible and continue to support its growth.
...
By participating and contributing to Magic Dart Auth SDK, you are expected to uphold our [Code of Conduct](CODE_OF_CONDUCT.md).
...
Magic Dart Auth SDK is available in two versions to cater to different needs and scales:

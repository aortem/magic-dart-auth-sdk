...
import 'package:magic/screens/link_with_credientials/link_with_credientials.dart';
import 'package:magic/screens/verify_password_reset_code_screen/verify_password_reset_code.dart';
import 'package:magic_dart_auth_sdk/magic_dart_auth_sdk.dart';
import 'package:magic/screens/apply_action_code_screen/apply_action_code_screen.dart';
import 'package:magic/screens/home_screen/home_screen_view_model.dart';
import 'package:magic/screens/parse_action_url_screen/parse_action_url.dart';
import 'package:magic/screens/set_language_code_screen/set_language_code_screen.dart';
import 'package:magic/screens/sign_up_screen/sign_up_screen.dart';
import 'package:magic/screens/storage_screen/storage.dart';
import 'package:magic/screens/unlink_provider_screen/unlink_provider_screen.dart';
import 'package:magic/screens/update_password_screen/update_password_screen.dart';
import 'package:magic/screens/update_profile_screen/update_profile_screen.dart';
import 'package:magic/screens/verify_before_email_update_screen/verify_before_email_update_screen.dart';
import 'package:magic/shared/shared.dart';
import 'package:magic/utils/extensions.dart';
import 'package:flutter/foundation.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'package:magic_dart_auth_sdk/src/auth/auth_state_changed.dart'
    as auth_state;
import 'package:magic_dart_auth_sdk/src/auth/id_token_changed.dart' as id_token;

import '../link_wit_phone_number/link_with_phone_number.dart';
import '../update_current_user/update_current_user.dart';
import 'package:magic/screens/get_redirect_result_screen/get_redirect_result_screen.dart';
import 'package:magic/screens/initialize_recaptcha_config_screen/initialize_recaptcha_config_screen.dart';
import 'package:magic/screens/multi_factor_resolver_screen/multi_factor_resolver_screen.dart';
import 'package:magic/screens/password_reset_screen/password_reset_screen.dart';
import 'package:magic/screens/fetch_sign_in_methods_for_email_screen/fetch_sign_in_methods_screen.dart';
import 'package:magic/screens/create_user_screen/create_user_screen.dart';
import 'package:magic/screens/confirm_password_reset_screen/confirm_password_reset_screen.dart';
import 'package:magic/screens/check_action_code_screen/check_action_code_screen.dart';
import 'package:magic/screens/is_sign_in_with_email_link_screen/is_sign_in_with_email_link_screen.dart';
import 'package:magic/screens/revoke_token_screen/revoke_token_screen.dart';
import 'package:magic/screens/on_Id_Token_Changed/on_id_token_changed.dart';
import 'package:magic/screens/auth_state_test_screen/auth_state_test_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _setupAuthListeners() {
    final auth = Provider.of<magicAuth>(context, listen: false);
            ...
            child: Column(
              ...
              children: [
                ...
                ActionTile(
                  onTap: () {
                    try {
                      magicApp.magicAuth?.signOut();
                      final magicApp = magicApp.instance;
                      final currentUser = magicApp.getCurrentUser();
                ...
                ActionTile(
                  onTap: () {
                    magicApp.magicAuth?.deletemagicUser();
                    final magicApp = magicApp.instance;
                    final currentUser = magicApp.getCurrentUser();
                ...
                ActionTile(
                  onTap: () async {
                    var tokenId = await magicApp.magicAuth?.getIdToken();
                    setState(() {
                      userIdToken = tokenId!;
                    });
                    if (kDebugMode) {
                ...
                ActionTile(
                  onTap: () async {
                    var tokenId = await magicApp.magicAuth?.getIdTokenResult();
                ...
                ActionTile(
                  onTap: () async {
                    magicApp.magicAuth?.setLanguageCodeMethod(
                ...
                ActionTile(
                  onTap: () async {
                    // var tokenId=
                    magicApp.magicAuth?.getAuthBeforeChange();
                  },

...
class GetRedirectResultViewModel extends ChangeNotifier {
  ...
  Future<void> getRedirectResults() async {
    ...
    try {
      ...
      final currentUser = magicApp.instance.getCurrentUser();
      if (currentUser == null) {
        _error = 'No signed-in user found';
        return;
      }

      final result = await magicApp.magicAuth?.getRedirectResult();
      ...
      _error =
          e is magicAuthException ? e.message : 'Failed to get redirect result';

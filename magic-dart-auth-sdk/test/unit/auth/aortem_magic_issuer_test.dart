...
void main() {
  group('IssuerExtractor.getIssuer', () {
    ...
    test('Throws error for empty DID Token', () {
      expect(() => AortemMagicIssuerExtractor.getIssuer('', strict: true),
          throwsA(isA<ArgumentError>()));
    });

    test('Throws error for invalid JWT format', () {
      expect(
          () => AortemMagicIssuerExtractor.getIssuer('invalid.token',
              strict: true),
    ...
    test('Throws error for invalid issuer format in strict mode', () {
      ...
      expect(() => AortemMagicIssuerExtractor.getIssuer(didToken, strict: true),
          throwsA(isA<FormatException>()));
    });
